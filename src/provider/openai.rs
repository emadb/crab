...
impl LlmClient for OpenAiClient {
    async fn send(
        ...
        // Some local servers omit the `id` delta on tool calls; keep resolution unambiguous by index.
...
fn to_wire(message: &Message) -> WireMessage {
    match message {
        ...
        Message::Tool { call_id, result } => WireMessage {
            role: "tool",
